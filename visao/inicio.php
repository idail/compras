            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        <i class="fa fa-shopping-basket" aria-hidden="true"></i><span class="nav-text">Produtos</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="index.php?pagina=cadastrar_produtos">Cadastrar</a></li>
                            <li><a href="index.php?pagina=consultar_produtos">Consultar</a></li>
